      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="storeApp.customerDetails.home.createOrEditLabel" data-cy="CustomerDetailsCreateUpdateHeading">
            <Translate contentKey="storeApp.customerDetails.home.createOrEditLabel">Create or edit a CustomerDetails</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('storeApp.customerDetails.gender')}
              ...
              <ValidatedField
                label={translate('storeApp.customerDetails.phone')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.customerDetails.addressLine1')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.customerDetails.addressLine2')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.customerDetails.city')}
              ...
              />
              <ValidatedField
                label={translate('storeApp.customerDetails.country')}
              ...
              <ValidatedField
                ...
                name="user"
                data-cy="user"
                label={translate('storeApp.customerDetails.user')}
                type="select"
                required
              >
                <option value="" key="0" />
